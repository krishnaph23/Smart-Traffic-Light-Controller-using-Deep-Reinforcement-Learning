...
class Simulation:
    ...
    def _get_state(self):
            ...
            vehicles_road1 = traci.edge.getLastStepVehicleIDs('W2TL')
            vehicles_road2 = traci.edge.getLastStepVehicleIDs('N2TL')
            vehicles_road3 = traci.edge.getLastStepVehicleIDs('E2TL')
