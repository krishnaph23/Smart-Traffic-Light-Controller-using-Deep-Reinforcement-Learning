    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            ...
            <vTypeDistribution id="high_priority">
                <vType id="amb" vClass="emergency" guiShape="emergency" speedDev="0.2" latAlignment="arbitrary" probability="0.4"></vType>
                <vType id="pol" vClass="authority" guiShape="police" speedDev="0.4" latAlignment="arbitrary" probability="0.4"></vType>
                <vType id="fire" vClass="emergency" guiShape="firebrigade" speedDev="0.4" latAlignment="arbitrary" probability="0.2"></vType>
            </vTypeDistribution>
