...
class Simulation:
    ...
    def __init__(self, Model, Memory, TrafficGen, sumo_cmd, gamma, max_steps, green_duration, yellow_duration, num_states, num_actions, training_epochs):
        ...
        self._num_actions = num_actions #4
        self._reward_store = []
    ...
    def _get_state(self):
        ...
        for car_id in car_list:
            ...
            if lane_id == "A2TL_0" or lane_id == "A2TL_1" or lane_id == "A2TL_2" or lane_id == "A2TL_3":
                lane_group = 0
            elif lane_id == "B2TL_0" or lane_id == "B2TL_1" or lane_id == "B2TL_2" or lane_id == "B2TL_3":
                lane_group = 1
            elif lane_id == "C2TL_0" or lane_id == "C2TL_1" or lane_id == "C2TL_2" or lane_id == "C2TL_3":
                lane_group = 2
            elif lane_id == "D2TL_0" or lane_id == "D2TL_1" or lane_id == "D2TL_2" or lane_id == "D2TL_3":
                lane_group = 3
            elif lane_id == "E2TL_0" or lane_id == "E2TL_1" or lane_id == "E2TL_2" or lane_id == "E2TL_3":
                lane_group = 4
            else:
                lane_group = -1
