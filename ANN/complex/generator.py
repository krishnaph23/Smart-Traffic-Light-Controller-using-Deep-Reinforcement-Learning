    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/episode_routes.rou.xml", "w") as routes:
            ...
            <vTypeDistribution id="low_priority">
                <vType id="standcar" vClass="passenger" guiShape="passenger" speedDev="0.2" latAlignment="arbitrary" sigma="0.5" probability="0.5" />
            ...
            for car_counter, step in enumerate(car_gen_steps):
                ...
                if route == 1:
                    ...
                    print('    <vehicle id="%sA_G%i" type="%s" route="A_G" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                    ...
                    print('    <vehicle id="%sB_G%i" type="%s" route="B_G" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                    ...
                    print('    <vehicle id="%sC_G%i" type="%s" route="C_G" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                    ...
                    print('    <vehicle id="%sD_G%i" type="%s" route="D_G" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                    ...
                    print('    <vehicle id="%sE_G%i" type="%s" route="E_G" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                    ...
                    print('    <vehicle id="%sF_G%i" type="%s" route="F_G" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                
                elif route == 37:
                    print('    <vehicle id="%sG_A%i" type="%s" route="G_A" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                elif route == 38:
                    print('    <vehicle id="%sG_B%i" type="%s" route="G_B" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                elif route == 39:
                    print('    <vehicle id="%sG_C%i" type="%s" route="G_C" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                elif route == 40:
                    print('    <vehicle id="%sG_D%i" type="%s" route="G_D" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                elif route == 41:
                    print('    <vehicle id="%sG_E%i" type="%s" route="G_E" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
                elif route == 42:
                    print('    <vehicle id="%sG_F%i" type="%s" route="G_F" depart="%s" departLane="random" departSpeed="10" />' % (pr, car_counter, veh_type, step), file=routes)
